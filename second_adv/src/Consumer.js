...
Consumer.prototype.onFinished = function(result) {
    if (result) console.log('all is ok');
    else console.log('process failed');
};

Consumer.prototype.getRabbitConection = function() {
...
*/
Consumer.prototype.processMessage = function(routingKey, message, ack) {
    var self = this;
    var startDoc;
    var onResult;
...
* @return {} nothing
*/
Consumer.prototype._setAcknowledge = function(ack, cb) {
    ack.acknowledge();
